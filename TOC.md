...
2. [Technical Setup](technical-setup.md)
...
**How to use:** Click on any chapter title to open that section in Markdown. Each chapter also includes navigation links at the bottom to move between sections.
